...
console.log("Parametros $scope.image 1 ->  " +$scope.image);

$http({
  method: 'POST',
  url: 'http://www.altavistaweb.com.ve/banight-api/public/api/v1/adduser',
  headers: 
  ...
  $scope.loadSexo = function() {
    ...
    buttons:[
        {
            text: "HOMBRE",
            type: 'genero-stilo icon-top icon-hombre',
            onTap: function(){
